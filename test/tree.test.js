...
describe("Unit tests for Tree Model", function() {
    ...
    it("Should add a tree to the database", function(done){
        var newTree = new Tree({name: "TestTree1", maxHeight: 1, averageHeight: 1, description: "A Tree", image: "/"})
            .then(() => {
    ...
    it("Should read a tree from the database", function(done){
        var newTree = new Tree({name: "TestTree2", maxHeight: 1, averageHeight: 1, description: "A Tree", image: "/"})
